<template>
  <b-card id="privacy">
    ...
    <p>
      ...
      for users leaving comments on {{ url }} blog posts. Annette von Brandis
    ...
    <p>
      ...
      with what's going on with Annette von Brandis and our products. We
      ...
      to your request or to help us support other users. Annette von Brandis
    ...
    <p>
      ...
      Brandis identify and track visitors, their usage of {{ url }}, and their
      website access preferences. Annette von Brandis visitors who do not wish
      to have cookies placed on their computers should set their browsers to
      refuse cookies before using Annette von Brandis's websites, with the
      drawback that certain features of Annette von Brandis's websites may not
