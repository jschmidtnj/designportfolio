  ...
  <b-container class="mt-4 mb-5">
    <b-card id="privacy">
      ...
      <p>
        ...
        Policy applies to
        <a :href="url">{{ url }}</a>
        (hereinafter, "us", "we", or "{{ url }}"). We respect your privacy and
      ...
      <p>
        ...
        request. Annette von Brandis's purpose in collecting non-personally
        identifying information is to better understand how Annette von
        Brandis's visitors use its website. From time to time, Annette von
        Brandis may release non-personally-identifying information in the
      ...
      <p>
        ...
        and for users leaving comments on {{ url }} blog posts. Annette von
        Brandis only discloses logged in user and commenter IP addresses under
      ...
      <p>
        Certain visitors to Annette von Brandis's websites choose to interact
        with Annette von Brandis in ways that require Annette von Brandis to
        gather personally-identifying information. The amount and type of
        information that Annette von Brandis gathers depends on the nature of
      ...
      <p>
        ...
        provide services available at Annette von Brandis's website, and (ii)
        ...
        transfer of such information to them. Annette von Brandis will not rent
        ...
        rights of Annette von Brandis, third parties or the public at large.
      </p>
      <p>
        If you are a registered user of {{ url }} and have supplied your email
        address, Annette von Brandis may occasionally send you an email to tell
        you about new features, solicit your feedback, or just keep you up to
        date with what's going on with Annette von Brandis and our products. We
        ...
        respond to your request or to help us support other users. Annette von
        Brandis takes all measures reasonably necessary to protect against the
      ...
      <p>
        Annette von Brandis may collect statistics about the behavior of
        visitors to its website. Annette von Brandis may display this
        information publicly or provide it to others. However, Annette von
        Brandis does not disclose your personally-identifying information.
      </p>
      ...
      <p>
        ...
        time the visitor returns. Annette von Brandis uses cookies to help
        Annette von Brandis identify and track visitors, their usage of
        {{ url }}, and their website access preferences. Annette von Brandis
        visitors who do not wish to have cookies placed on their computers
        should set their browsers to refuse cookies before using Annette von
        Brandis's websites, with the drawback that certain features of Annette
        von Brandis's websites may not function properly without the aid of
        cookies.
      </p>
      <p>
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to Annette von Brandis's use
        of cookies.
      </p>
      ...
      <p>
        ...
        change its Privacy Policy from time to time, and in Annette von
        Brandis's sole discretion. Annette von Brandis encourages visitors to
