<template>
  <div id="privacy">
    ...
    Annette von Brandis is located at:
    <br />
    <address>
      Annette von Brandis
      <br />
    ...
    <p>
      It is Annette von Brandis's policy to respect your privacy regarding any
      information we may collect while operating our website. This Privacy
      Policy applies to
      <a href="https://annettevonbrandis.com">https://annettevonbrandis.com</a>
      (hereinafter, "us", "we", or "https://annettevonbrandis.com"). We respect
    ...
    <p>
      Like most website operators, Annette von Brandis collects
      ...
      Annette von Brandis's purpose in collecting non-personally identifying
      information is to better understand how Annette von Brandis's visitors use
      its website. From time to time, Annette von Brandis may release
      non-personally-identifying information in the aggregate, e.g., by
      publishing a report on trends in the usage of its website.
    </p>
    <p>
      Annette von Brandis also collects potentially personally-identifying
      information like Internet Protocol (IP) addresses for logged in users and
      for users leaving comments on https://annettevonbrandis.com blog posts.
      Annette von Brandis only discloses logged in user and commenter IP
    ...
    <p>
      Certain visitors to Annette von Brandis's websites choose to interact with
      Annette von Brandis in ways that require Annette von Brandis to gather
      personally-identifying information. The amount and type of information
      that Annette von Brandis gathers depends on the nature of the interaction.
      For example, we ask visitors who sign up for a blog at
      https://annettevonbrandis.com to provide a username and email address.
    </p>
    ...
    <p>
      ...
      Privacy Policy covers the use of cookies by Annette von Brandis and does
    ...
    <h2>Https://annettevonbrandis.com uses Google AdWords for remarketing</h2>
    <p>
      Https://annettevonbrandis.com uses the remarketing services to advertise
      ...
      search results page, or a site in the Google Display Network. Third-party
      vendors, including Google, use cookies to serve ads based on someone's
      past visits. Of course, any data collected will be used in accordance with
    ...
    <p>
      ...
      advertising entirely by cookie settings or permanently using a browser
      plugin.
    </p>

    <h2>Protection of Certain Personally-Identifying Information</h2>
    <p>
      Annette von Brandis discloses potentially personally-identifying and
      personally-identifying information only to those of its employees,
      contractors and affiliated organizations that (i) need to know that
      information in order to process it on Annette von Brandis's behalf or to
      provide services available at Annette von Brandis's website, and (ii) that
      ...
      home country; by using Annette von Brandis's website, you consent to the
      transfer of such information to them. Annette von Brandis will not rent or
      ...
      affiliated organizations, as described above, Annette von Brandis
      ...
      governmental request, or when Annette von Brandis believes in good faith
      that disclosure is reasonably necessary to protect the property or rights
      of Annette von Brandis, third parties or the public at large.
    </p>
    <p>
      If you are a registered user of https://annettevonbrandis.com and have
      supplied your email address, Annette von Brandis may occasionally send you
      an email to tell you about new features, solicit your feedback, or just
      keep you up to date with what's going on with Annette von Brandis and our
      ...
      Annette von Brandis takes all measures reasonably necessary to protect
    ...
    <p>
      Annette von Brandis may collect statistics about the behavior of visitors
      to its website. Annette von Brandis may display this information publicly
      or provide it to others. However, Annette von Brandis does not disclose
      your personally-identifying information.
    </p>

    <h2>Cookies</h2>
    <p>
      To enrich and perfect your online experience, Annette von Brandis uses
    ...
    <p>
      ...
      the visitor returns. Annette von Brandis uses cookies to help Annette von
      Brandis identify and track visitors, their usage of
      https://annettevonbrandis.com, and their website access preferences.
      Annette von Brandis visitors who do not wish to have cookies placed on
      their computers should set their browsers to refuse cookies before using
      Annette von Brandis's websites, with the drawback that certain features of
      Annette von Brandis's websites may not function properly without the aid
      of cookies.
    </p>
    <p>
      By continuing to navigate our website without changing your cookie
      settings, you hereby acknowledge and agree to Annette von Brandis's use of
      cookies.
    </p>

    <h2>Privacy Policy Changes</h2>
    <p>
      Although most changes are likely to be minor, Annette von Brandis may
      change its Privacy Policy from time to time, and in Annette von Brandis's
      sole discretion. Annette von Brandis encourages visitors to frequently
    ...
    <p>
      ...
      <a href="mailto:annettevonbrandis@gmail.com">email</a> or
